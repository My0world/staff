    ...
    <div class="DimissionAudit">
        <el-tabs v-model="activeName" type="card" :class="[theme === 'light' ? 'light' : 'dark']">
            <el-tab-pane label="全部" name="全部">
                <AuditList v-if="activeName === '全部'" status="全部"></AuditList>
            </el-tab-pane>
            <el-tab-pane label="待审核" name="待审核">
                <AuditList v-if="activeName === '待审核'" status="待审核"></AuditList>
            </el-tab-pane>
            <el-tab-pane label="审核通过" name="审核通过">
                <AuditList v-if="activeName === '审核通过'" status="审核通过"></AuditList>
            </el-tab-pane>
            <el-tab-pane label="审核驳回" name="审核驳回">
                <AuditList v-if="activeName === '审核驳回'" status="审核驳回"></AuditList>
            </el-tab-pane>
        </el-tabs>
    </div>
</template>
