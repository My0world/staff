                ...
                <Card class="table" title="已发送" :theme="theme">
                    <template v-slot:body>
                        <div class="OperatingList" :class="[theme === 'light' ? 'light' : 'dark']">
                            ...
                            <el-pagination v-model:current-page="sendForm.pageNo" :page-size="12"
                                layout=" jumper, total,->, prev, pager, next," :total="sendTotal" :background="true"
...
const handleFilter = async () => {
    ...
    await filterSendData(sendForm.value).then((resolve) => {
        //动画结束
